...
exports.constants = exports.HARDENED = exports.BitBox02API = void 0;
exports.getDevicePath = getDevicePath;
exports.isErrorAbort = void 0;

var _bitbox02ApiGo = require("./bitbox02-api-go.js");
...
var api = _bitbox02ApiGo.bitbox02;
var constants = _bitbox02ApiGo.bitbox02.constants;
exports.constants = constants;
var isErrorAbort = _bitbox02ApiGo.bitbox02.IsErrorAbort;
...
function _getDevicePath() {
  _getDevicePath = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee18() {
    var options,
        forceBridge,
        attempts,
        i,
      ...
      while (1) {
        switch (_context18.prev = _context18.next) {
          case 0:
            ...
            forceBridge = options && options.forceBridge;
            ...
            return _context18.abrupt("return", webHID);
          ...
          case 28:
            devices = _context18.sent.devices;
          ...
          case 33:
            ...
            return _context18.abrupt("return", devicePath);
  ...
  _createClass(BitBox02API, [{
    ...
    value: function () {
      var _ethGetRootPubKey = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee10(keypath) {
        var keypathArray, chainID, xpub;
        return regeneratorRuntime.wrap(function _callee10$(_context10) {
          while (1) {
            switch (_context10.prev = _context10.next) {
              case 0:
                keypathArray = (0, _utils.getKeypathFromString)(keypath);
                chainID = (0, _utils.getChainIDFromKeypath)(keypathArray);
                _context10.next = 4;
                return this.firmware().js.AsyncETHPub(chainID, keypathArray, constants.messages.ETHPubRequest_OutputType.XPUB, false, new Uint8Array());
          ...
          while (1) {
            switch (_context11.prev = _context11.next) {
              case 0:
                ...
                keypathArray = (0, _utils.getKeypathFromString)(keypath); // FIXME: see def of `getChainIDFromKeypath()`, since we use the same keypath for Ropsten and Rinkeby,
                // the title for Rinkeby addresses will show 'Ropsten' instead

                chainID = (0, _utils.getChainIDFromKeypath)(keypathArray);
                return _context11.abrupt("return", this.firmware().js.AsyncETHPub(chainID, keypathArray, constants.messages.ETHPubRequest_OutputType.ADDRESS, display, new Uint8Array()));
    ...
    function () {
      var _ethSignTransaction = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee12(signingData) {
        var sig, vOffset, v, vBuf, vArr, result;
          ...
          while (1) {
            switch (_context12.prev = _context12.next) {
              case 0:
                _context12.prev = 0;
                _context12.next = 3;
                return this.fw.js.AsyncETHSign(signingData.chainId, (0, _utils.getKeypathFromString)(signingData.keypath), signingData.tx.nonce, signingData.tx.gasPrice, signingData.tx.gasLimit, signingData.tx.to, signingData.tx.value, signingData.tx.data);

              case 3:
                sig = _context12.sent;
                vOffset = signingData.chainId * 2 + 8;
                v = sig[64] + 27 + vOffset; // Convert `v` to big-endian Uint8Array.

                vBuf = new ArrayBuffer(8);
                new DataView(vBuf).setBigUint64(0, BigInt(v));
                vArr = new Uint8Array(vBuf); // Remove leading zeroes.

                vArr = vArr.subarray(vArr.findIndex(function (el) {
                  return el != 0;
                }));
                result = {
                  r: sig.slice(0, 0 + 32),
          ...
          while (1) {
            switch (_context13.prev = _context13.next) {
              case 0:
                ...
                _context13.next = 4;
                return this.firmware().js.AsyncETHSignMessage((0, _utils.getChainIDFromKeypath)(keypath), keypath, msgData.message);
    ...
    key: "ethSignTypedMessage",
    value: function () {
      var _ethSignTypedMessage = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee14(msgData) {
        var sig, result;
          ...
          while (1) {
            switch (_context14.prev = _context14.next) {
              case 0:
                _context14.prev = 0;
                _context14.next = 3;
                return this.firmware().js.AsyncETHSignTypedMessage(msgData.chainId, (0, _utils.getKeypathFromString)(msgData.keypath), JSON.stringify(msgData.message));
              ...
              case 8:
                ...
                if (!api.IsErrorAbort(_context14.t0)) {
                  _context14.next = 14;
                  break;
                }
      ...
      function ethSignTypedMessage(_x38) {
        return _ethSignTypedMessage.apply(this, arguments);
      }

      return ethSignTypedMessage;
    ...
    key: "cardanoXPubs",
    value: function () {
      var _cardanoXPubs = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee15(keypaths) {
        return regeneratorRuntime.wrap(function _callee15$(_context15) {
          while (1) {
            switch (_context15.prev = _context15.next) {
              case 0:
                _context15.next = 2;
                return this.firmware().js.AsyncCardanoXPubs(keypaths);
      ...
      function cardanoXPubs(_x39) {
        return _cardanoXPubs.apply(this, arguments);
      }
     ...
     */
    function () {
      var _cardanoAddress = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee16(network, scriptConfig) {
        var display,
            _args16 = arguments;
        return regeneratorRuntime.wrap(function _callee16$(_context16) {
          while (1) {
            switch (_context16.prev = _context16.next) {
              case 0:
                display = _args16.length > 2 && _args16[2] !== undefined ? _args16[2] : true;
                _context16.next = 3;
                return this.firmware().js.AsyncCardanoAddress(network, scriptConfig, display);
      ...
      function cardanoAddress(_x40, _x41) {
        return _cardanoAddress.apply(this, arguments);
      }

      return cardanoAddress;
    }()
  }, {
    key: "cardanoSignTransaction",
    value:
    /**
     ...
     */
    function () {
      var _cardanoSignTransaction = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee17(_ref2) {
        var network, inputs, outputs, fee, ttl, certificates, withdrawals, validityIntervalStart, i, allowZeroTTL;
        return regeneratorRuntime.wrap(function _callee17$(_context17) {
          while (1) {
            switch (_context17.prev = _context17.next) {
              case 0:
                network = _ref2.network, inputs = _ref2.inputs, outputs = _ref2.outputs, fee = _ref2.fee, ttl = _ref2.ttl, certificates = _ref2.certificates, withdrawals = _ref2.withdrawals, validityIntervalStart = _ref2.validityIntervalStart;
                ...
                allowZeroTTL = !!ttl;
                _context17.next = 5;
                return this.firmware().js.AsyncCardanoSignTransaction(network, inputs || [], outputs || [], fee, ttl || "0", certificates || [], withdrawals || [], validityIntervalStart || "0", allowZeroTTL);
      ...
      function cardanoSignTransaction(_x42) {
        return _cardanoSignTransaction.apply(this, arguments);
      }
